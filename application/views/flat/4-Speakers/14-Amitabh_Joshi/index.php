...
<div id="grid" class="container gap-above">
    <div class="row">
        <div class="col-md-9 main">
            <h1>Amitabh Joshi</h1>
            <img src="<?=PUBLIC_URL?>images/stock/Amitabh_Joshi.jpg" class="profile-thumb" alt="Amitabh Joshi" />
            <p class="affiliation">
