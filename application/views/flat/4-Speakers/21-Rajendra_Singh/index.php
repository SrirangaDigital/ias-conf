...
<div id="grid" class="container gap-above">
    <div class="row">
        <div class="col-md-9 main">
            ...
            <p>
                <strong>Rajendra Singh,</strong> Tarun Bharat Sangh, Alwar (Rajasthan), Singh is a highly respected social activist working with water and river issues in India. Singh started Tarun Bharat Sangh for building and maintaining johads. In over 30 years, rivulets dry for 80 years were revived. He launched the Rashtriya Jal Biradari (National Water Community) in 2001 to provide a platform for concerned citizens to discuss and debate water issues. Rashtriya Jal Biradari now has over 5000 members. He also started the Jan Jan Jodo (Linking Water and People) campaign in 2013 focusing on educating communities in river catchment areas about the causes and prevention of pollution, encroachment and over-exploitation of river waters.                
            </p>

            <div class="talk">
                <p class="type">Session 1E - Public lecture</p>
                <p class="title">Indigenous knowledge system of water management in India</p>
                <p class="abstract">
                ...
                <p class="abstract">
                    This indigenous knowledge systemhad acknowledged the diversity in agro-ecological zones even those that seems inhospitable, and had developed a specific science, a relevant engineering and a technology appropriate to each part of the country to enable living in a sustainable manner with Nature. 
                </p>
                <p class="abstract">           
