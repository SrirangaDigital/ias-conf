...
<div id="grid" class="container gap-above">
    <div class="row">
        <div class="col-md-9 main">
            ...
            <p>
                <strong>Swapan K Ghosh,</strong> BARC, Mumbai, elected to Fellowship in 1991, Ghoshs research interests include theoretical chemistry, computational materials science and soft condensed matter physics. He is Raja Ramanna Fellow at BARC, Mumbai, Senior Professor at HBNI, Mumbai and also Distinguished Professor at UM-DAE-Centre of Excellence in Basic Sciences, Mumbai. He is the recipient of the TWAS Prize in Chemistry from TWAS, Trieste, Italy.
            </p>

            <div class="talk">
                <p class="type">Session 1D - Walter Kohn Memorial Symposium</p>
                <p class="title">Density functional theory for materials modelling at different length scales: A legacy of Walter Kohn</p>
                <p class="abstract">
